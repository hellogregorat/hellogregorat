...
Лендинг для люксового агентства недвижимости в Нью-Йорке. Стек: React, Redux Toolkit, Framer Motion, Tailwind.
Интерактивные фильтры по типу/цене, избранное, модалка с деталями объекта и плавные анимации — фронтенд без бэкенда.
