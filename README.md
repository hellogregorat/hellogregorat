...
<h1 align="center">Привет 👋, я Гриша</h1>

<p align="center">
  <b>hellogregorat</b> · 18 лет · Frontend-разработчик из России 🇷🇺
</p>
...
**Формат:** удалённо / офис (укажи город) &nbsp;|&nbsp; **Готовность:** стажировка / junior-позиция &nbsp;|&nbsp; **Стек:** React, JavaScript, HTML/CSS
...
Я веб-разработчик. Больше всего мне нравится **фронтенд** — люблю делать интерфейсы, с которыми приятно взаимодействовать. Сейчас параллельно изучаю бэкенд (укажи стек, например Node.js или Python), чтобы лучше понимать, как всё работает под капотом.
...
| **JavaScript (Vanilla)** — чистый JS без лишних зависимостей | уверенно | Technology-integration |
| **React** — основной фреймворк для интерфейсов | уверенно | NEON-PANG |
...
- Настольный теннис
- Кодить по вечерам
- Разбираться, как под капотом работает React
