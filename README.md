...
Я веб-разработчик. Больше всего мне нравится **фронтенд** — люблю делать интерфейсы, с которыми приятно взаимодействовать. Сейчас параллельно изучаю бэкенд, стек: Node.js, чтобы лучше понимать, как всё работает под капотом.
